    ...
    <div className='hero'>
      <div className='right'>
        <div className='flex flex-col w-full justify-center items-start text-center md:text-left'>
          ...
          <button
            className='mx-auto lg:mx-0 bg-emerald-700 opacity-80 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out'>
            Earn Rewards
          </button>
        </div>
      </div>
